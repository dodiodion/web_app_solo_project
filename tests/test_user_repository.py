...
def test_get_user_with_post_id(db_connection):
    ...
    assert user == User(1, "Guest", "bob@gmail.com", "Guest",  "8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92")
...
def test_create_user(db_connection):
    ...
    assert users == [User(1, "Guest", "bob@gmail.com", "Guest", "8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92"),
...
def test_get_all_users(db_connection): # See conftest.py to learn what `db_connection` is.
    ...
    assert users == [User(1, "Guest", "bob@gmail.com", "Guest", 
                        "8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92"),
                    User(2, "Bob Gratton", "bob_gratton@hotmail.com", "bob_gratton", 
                        "ba28e715bb87f8126262007fd9651d3cae6a60faa48ccf8b62124b0fb7f6e01b")]
...
def test_find_user_by_email(db_connection):
    db_connection.seed("seeds/post_user.sql") # Seed our database with some test data
    repository = UserRepository(db_connection)
    user = repository.find_by_email("bob_gratton@hotmail.com")
    assert user == User(2, "Bob Gratton", "bob_gratton@hotmail.com", "bob_gratton", 
                        "ba28e715bb87f8126262007fd9651d3cae6a60faa48ccf8b62124b0fb7f6e01b")

"""
Find user, given their id
"""
